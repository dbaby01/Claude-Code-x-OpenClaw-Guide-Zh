...
> - **难度等级**：⭐⭐ 基础进阶
> - **更新日期**：2026年5月
> - **适用版本**：Codex App 当前版本 / Codex CLI v0.128.0（验证于 2026-04-30）
...
| 官方主题 | 你需要掌握什么 |
|----------|----------------|
| Features | Local / Worktree 模式、Git 工具、终端、浏览器、Computer Use、Web search、MCP、图片生成、记忆、通知 |
...
Computer Use 是让 Codex 操作桌面应用的能力。官方当前说明强调 macOS 权限：启用后需要关注 Screen Recording、Accessibility 等系统级权限；要撤销访问，需要到 macOS Privacy & Security 中处理。该功能在 EEA、英国、瑞士首发不可用。
