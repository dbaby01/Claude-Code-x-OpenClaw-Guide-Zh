...
> - **信息来源**：[Codex Rules 文档](https://developers.openai.com/codex/rules) | [Codex Hooks 文档](https://developers.openai.com/codex/hooks) | [App Features](https://developers.openai.com/codex/app/features)
...
Computer Use 涉及系统级权限和桌面操作。官方当前主描述偏 macOS app 操作，App Settings 中强调 macOS 需要关注 Screen Recording / Accessibility 等系统权限；要撤销需到系统 Privacy & Security 处理。Windows 权限和可用性以当前 App 设置与官方平台说明为准。
