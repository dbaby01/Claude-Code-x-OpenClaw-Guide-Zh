...
> - **信息来源**：[Config Basics](https://developers.openai.com/codex/config-basic) | [Config Reference](https://developers.openai.com/codex/config-reference) | [Codex Rules 文档](https://developers.openai.com/codex/rules) | [Codex Hooks 文档](https://developers.openai.com/codex/hooks)
