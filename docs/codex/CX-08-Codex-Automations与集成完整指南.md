...
> - **信息来源**：[Codex Automations 文档](https://developers.openai.com/codex/app/automations) | [Codex GitHub Action](https://developers.openai.com/codex/github-action) | [Codex GitHub](https://github.com/openai/codex)
