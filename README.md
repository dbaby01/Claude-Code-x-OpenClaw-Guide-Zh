...
- **🔄 持续更新**：适配最新稳定版（Claude Code v2.1.158 / OpenClaw 稳定版 v2026.5.27 / Codex App 26.527，实际以 App 更新日志和本机 App 信息为准）
...
- **Codex App**：当前主线按 App 26.527（2026-05-29 官方 changelog；本机 Windows 包 26.527.3686.0）复核；macOS 从官方 Codex App 入口安装，Windows 以 Microsoft Store / `winget -s msstore` 等官方安装入口为准
...
| **Codex版本** | Codex App 26.527（2026-05-29 官方 changelog；本机 Windows 包 26.527.3686.0）；CLI 仅作辅助，实际以 App 更新日志、系统应用信息和官方文档为准 |
...
| Codex App | 26.527（Windows 包 26.527.3686.0） | 2026-05-31 | [Codex changelog](https://developers.openai.com/codex/changelog) |
...
- Claude Code 教程基于 **v2.1.158** 编写（[Release](https://github.com/anthropics/claude-code/releases/tag/v2.1.158)）；OpenClaw 教程以 **稳定版 v2026.5.27** 为修订参考；Codex 教程按 **Codex App 26.527 与 2026-05 OpenAI 官方 Codex 文档** 修订，CLI 仅作为 CX-12 辅助路径，实际版本以本机和官方文档为准
