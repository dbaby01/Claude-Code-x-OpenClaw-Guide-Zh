...
**Codex 教程内容**
- CX-01 安装与认证：Windows Microsoft Store / 防火墙，macOS 官方下载 / Gatekeeper，登录、本地项目、首个线程
- CX-02 App 桌面工作流：Thread、Local、Worktree、Review、Settings、App 主控台模型
- CX-03 Commands：App slash commands、`/status`、`/plan-mode`、`/review`、`/mcp`，以及 `/goal`、`/loop` 等实验入口确认方法
- CX-04 项目指令、权限与配置：AGENTS.md、App Settings、权限、沙盒、Rules、Hooks
- CX-05 到 CX-10：MCP、Skills、Plugins / Connectors、Subagents、Automations、Review / GitHub / PR
- CX-11 到 CX-14：Web / Cloud 辅助、CLI 辅助、安全企业、Claude Code 对比
